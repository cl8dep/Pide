...
import { MutedText, SectionTitle, NextImage } from "~/components";
import {
  StepTitle,
  IconContainer,
  StepContainer,
      ...
      <StepsContainer>
        <Grid container justifyContent="center">
          <Grid item xs={12} sm={6} md={4}>
            <StepContainer>
              <IconContainer>
                <NextImage src={StoreIcon} layout="fill" />
              </IconContainer>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <StepContainer>
              <IconContainer>
                <NextImage src={ProductIcon} layout="fill" />
              </IconContainer>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <StepContainer>
              <IconContainer>
                <NextImage src={ClientIcon} layout="fill" />
              </IconContainer>
              <StepTitle>Agregue su primer producto</StepTitle>
              <StepDescription>
